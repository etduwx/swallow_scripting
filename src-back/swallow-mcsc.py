...
xc = subprocess.Popen(["xcc", "-E","-I" + toolsdir + " /home/edward/swallow_tools/tool_xmp16_manycore/code/sc_swallow_communication/module_swallow_comms/src/", sys.argv[1], "manycore.xn"], stdout=subprocess.PIPE).communicate()[0]
xc = re.sub("^#.*\n","",xc,0,re.M)

...
# 1 "platform.h" 1 3
# 21 "platform.h" 3
# 1 "/home/sld-user/swallow/swallow_scripting/src-back/cchpSJzk.h" 1
# 4 "/home/sld-user/swallow/swallow_scripting/src-back/cchpSJzk.h"
# 1 "xs1.h" 1 3
# 31 "xs1.h" 3
...
# 5 "/home/sld-user/swallow/swallow_scripting/src-back/cchpSJzk.h" 2
# 13 "/home/sld-user/swallow/swallow_scripting/src-back/cchpSJzk.h"
...
void __initLinks()
{
  ...
  c = getChanend( (( (((0xf0202 >> 16)/(sw_ncols) << ( ( ( 0 + 1 ) + 1 ) + 6 ) ) | ((0xf0202 >> 16)%(sw_ncols) << ( 0 + 1 ) )) << 16) | (0xf0202 & 0xffff)) );
  asm("ecallf %0"::"r"(c));
  c = getChanend( (( (((0x110102 >> 16)/(sw_ncols) << ( ( ( 0 + 1 ) + 1 ) + 6 ) ) | ((0x110102 >> 16)%(sw_ncols) << ( 0 + 1 ) )) << 16) | (0x110102 & 0xffff)) );
  asm("ecallf %0"::"r"(c));
...
# 72 "scmain_16.xc"
  par
  {
    nOS_start( (( (((0x00100102 >> 16)/(sw_ncols) << ( ( ( 0 + 1 ) + 1 ) + 6 ) ) | ((0x00100102 >> 16)%(sw_ncols) << ( 0 + 1 ) )) << 16) | (0x00100102 & 0xffff)) , (( (((0x00100202 >> 16)/(sw_ncols) << ( ( ( 0 + 1 ) + 1 ) + 6 ) ) | ((0x00100202 >> 16)%(sw_ncols) << ( 0 + 1 ) )) << 16) | (0x00100202 & 0xffff)) ,0);

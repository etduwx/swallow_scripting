...
# 1 "platform.h" 1 3
# 21 "platform.h" 3
# 1 "/home/sld-user/swallow/swallow_scripting/src-back/ccimy42c.h" 1
# 4 "/home/sld-user/swallow/swallow_scripting/src-back/ccimy42c.h"
# 1 "xs1.h" 1 3
# 31 "xs1.h" 3
...
# 5 "/home/sld-user/swallow/swallow_scripting/src-back/ccimy42c.h" 2
# 13 "/home/sld-user/swallow/swallow_scripting/src-back/ccimy42c.h"
...
void __initLinks()
{
  ...
  c = getChanend( (( (((0x50202 >> 16)/(sw_ncols) << ( ( ( 0 + 1 ) + 1 ) + 6 ) ) | ((0x50202 >> 16)%(sw_ncols) << ( 0 + 1 ) )) << 16) | (0x50202 & 0xffff)) );
  asm("ecallf %0"::"r"(c));
  c = getChanend( (( (((0x70102 >> 16)/(sw_ncols) << ( ( ( 0 + 1 ) + 1 ) + 6 ) ) | ((0x70102 >> 16)%(sw_ncols) << ( 0 + 1 ) )) << 16) | (0x70102 & 0xffff)) );
  asm("ecallf %0"::"r"(c));
...
# 72 "scmain_6.xc"
  par
  {
    nOS_start( (( (((0x00060102 >> 16)/(sw_ncols) << ( ( ( 0 + 1 ) + 1 ) + 6 ) ) | ((0x00060102 >> 16)%(sw_ncols) << ( 0 + 1 ) )) << 16) | (0x00060102 & 0xffff)) , (( (((0x00060202 >> 16)/(sw_ncols) << ( ( ( 0 + 1 ) + 1 ) + 6 ) ) | ((0x00060202 >> 16)%(sw_ncols) << ( 0 + 1 ) )) << 16) | (0x00060202 & 0xffff)) ,0);

...
void __initLinks()
{
  ...
  c = getChanend( (( (((0xe0202 >> 16)/(sw_ncols) << ( ( ( 0 + 1 ) + 1 ) + 6 ) ) | ((0xe0202 >> 16)%(sw_ncols) << ( 0 + 1 ) )) << 16) | (0xe0202 & 0xffff)) );
  asm("ecallf %0"::"r"(c));
  c = getChanend( (( (((0x100102 >> 16)/(sw_ncols) << ( ( ( 0 + 1 ) + 1 ) + 6 ) ) | ((0x100102 >> 16)%(sw_ncols) << ( 0 + 1 ) )) << 16) | (0x100102 & 0xffff)) );
  asm("ecallf %0"::"r"(c));
...
# 72 "scmain_15.xc"
  par
  {
    nOS_start( (( (((0x000f0102 >> 16)/(sw_ncols) << ( ( ( 0 + 1 ) + 1 ) + 6 ) ) | ((0x000f0102 >> 16)%(sw_ncols) << ( 0 + 1 ) )) << 16) | (0x000f0102 & 0xffff)) , (( (((0x000f0202 >> 16)/(sw_ncols) << ( ( ( 0 + 1 ) + 1 ) + 6 ) ) | ((0x000f0202 >> 16)%(sw_ncols) << ( 0 + 1 ) )) << 16) | (0x000f0202 & 0xffff)) ,0);

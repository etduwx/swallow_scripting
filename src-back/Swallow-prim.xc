...
void xc_listen_check_wall(unsigned parentCommunicationChannel, unsigned rank,chanend north_connection,chanend east_connection,chanend south_connection,chanend west_connection,chanend com_channel,chanend consensus_channel){
	...
	unsigned walls[(MAZEWIDTH/DIV_DEGREE_X+1) * (MAZELENGTH/DIV_DEGREE_Y) + (MAZELENGTH/DIV_DEGREE_Y + 1) * (MAZELENGTH/DIV_DEGREE_X)+1];
...
com_channel :> index;
	     if(index >=((MAZELENGTH/DIV_DEGREE_Y)+1)*(MAZEWIDTH/DIV_DEGREE_X)){
		     ...
		     if(column == 0){
			     ...
			     if(visited[row][MAZEWIDTH/DIV_DEGREE_X-1] == 0) num_visited++;
		     ...
		     if(row == 0){
			     ...
			     if(visited[MAZELENGTH/DIV_DEGREE_Y-1][column] == 0) num_visited++;
 ...
 numero++;
  while(1){
	  ...
	  if(index >=((MAZELENGTH/DIV_DEGREE_Y)+1)*(MAZEWIDTH/DIV_DEGREE_X)){
		  ...
		  if(column !=0 && column != MAZEWIDTH/DIV_DEGREE_X){
	...
	//printMany(2,print_ids);
			  ...
			  com_channel <: index;
com_channel :> foo;
	     if(column > 0 && (rank % DIV_DEGREE_X != DIV_DEGREE_X - 1)){
		print_ids[0] = rank + 0x30000000;
	print_ids[1] = 2;
	//printMany(2,print_ids);
	...
	//printMany(2,print_ids);
			     ...
			     break;			
	     }else if(column==0 && (rank % DIV_DEGREE_X != 0)){
				print_ids[0] = rank + 0x30000000;
	print_ids[1] = 4;
	//printMany(2,print_ids);
	...
	//printMany(2,print_ids);
			  ...
			  com_channel <: index ;
com_channel :> foo;
	     if(row > 0 &&(rank/DIV_DEGREE_X != DIV_DEGREE_Y - 1) ){
			print_ids[0] = rank + 0x30000000;
	print_ids[1] = 3;
	//printMany(2,print_ids);
	...
	//printMany(2,print_ids);
			     ...
			     break;			
	     }else if(row==0 && (rank >= DIV_DEGREE_X)){ 
					print_ids[0] = rank + 0x30000000;
	print_ids[1] = 1;
	//printMany(2,print_ids);
